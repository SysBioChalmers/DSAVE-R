...
#' @param sortGenes .
#' @param name_join for inner and outerjoin the name of the added Sample object if it was a matrix
...
#   fullOuterJoin = function(ds, name_join = "", scale = TRUE){
#     if(!is.matrix(ds) & class(ds)[1] != "Samples"){
#       stop("The ds is not a matrix neither a Sample object")
#     }
#     if(is.matrix(ds)){
