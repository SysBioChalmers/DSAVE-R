#' bulkTotalVar4vs4
#'
#' Average total variation between bulk samples at different expression intervals (reasonably comparable
#' to TPM). The samples are first averaged four by four, and then compared, giving a lower variation than
#' in the 1vs1 case.
#'
